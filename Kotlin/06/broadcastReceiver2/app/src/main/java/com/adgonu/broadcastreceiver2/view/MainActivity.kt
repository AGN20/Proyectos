package com.adgonu.broadcastreceiver2.view
...
import com.adgonu.broadcastreceiver2.R
import com.adgonu.broadcastreceiver2.adapter.RecyclerViewAdapter
import com.adgonu.broadcastreceiver2.databinding.ActivityMainBinding
import com.adgonu.broadcastreceiver2.model.Mensaje
import com.adgonu.broadcastreceiver2.notification.CHANNEL_ID
import com.adgonu.broadcastreceiver2.notification.CHANNEL_NAME
import com.adgonu.broadcastreceiver2.notification.NOTIFICATION_ID
import com.adgonu.broadcastreceiver2.notification.PENDING_REQUEST
import com.adgonu.broadcastreceiver2.receiver.MyBroadcastReceiver
import com.adgonu.broadcastreceiver2.viewmodel.MensajeViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendMessage() {
        ...
        if(!binding.tvEscribir.text.toString().isEmpty()){
            ...
            Intent().also { intent ->
                ...
                intent.putExtra("dataBroadcastReceiver1", binding.tvEscribir.text.toString())
    ...
    private fun createNotifications(string: String) {
        ...
        with(builder){
            setSmallIcon(R.drawable.chat2) //Icon
            setContentTitle("Aplicacion 1").color = Color.BLUE //Color
