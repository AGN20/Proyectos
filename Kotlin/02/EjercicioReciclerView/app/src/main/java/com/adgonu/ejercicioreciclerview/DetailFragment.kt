...
import com.adgonu.ejercicioreciclerview.extension.setBitmapfromString
import com.adgonu.ejercicioreciclerview.extension.toBitmap
...
class DetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<ImageView>(R.id.ivPoster).setBitmapfromString(superHero?.photo?:"")
