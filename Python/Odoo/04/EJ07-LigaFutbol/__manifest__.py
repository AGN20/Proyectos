# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        #Comento esto porque me da error y rebisando no he podido encontrar el error
        #'report/partido_clasificacion.xml'
        ...
        #Comento igual que el otro porque no se porque me da error, he rebisado el error y los wizards pero no entiendo el motivo del error
